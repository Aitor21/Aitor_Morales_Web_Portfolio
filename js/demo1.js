{
    ...
    const firstPageContent = {
        ...
        entertwo: content.first.querySelector('.intro__entersecond')
    };
    ...
    const showNextPage = () => {
        ...
        .to(firstPageContent.entertwo, duration*0.5, {
            ease: ease,
            opacity: 0
        }, 0)
    ...
    firstPageContent.entertwo.addEventListener('click', showNextPage);
